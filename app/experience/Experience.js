...
class Experience{
    ...
    _calculateLevel() {
        ...
        while (this._experience >= requiredExperience && level < constants.MAX_LEVEL) {
        level++;
    ...
    get experienceRemaining(){
        ...
        const requiredExperience = constants.BASE_EXPERIENCE + (constants.EXPERIENCE_MULTIPLIER * (nextLevel - 1));
